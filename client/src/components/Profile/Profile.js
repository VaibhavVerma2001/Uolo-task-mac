            ...
            <form >
                <div className="form-container">
                    ...
                    <svg width="148" height="148" viewBox="0 0 148 148" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <circle cx="124" cy="124" r="20" fill="white" stroke="#D0D5DD" stroke-width="2" />
                        <path d="M133 127V131C133 131.53 132.789 132.039 132.414 132.414C132.039 132.789 131.53 133 131 133H117C116.47 133 115.961 132.789 115.586 132.414C115.211 132.039 115 131.53 115 131V127M129 120L124 115M124 115L119 120M124 115V127" stroke="#561FE7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
